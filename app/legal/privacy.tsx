    ...
    return (
      <div style={{ backgroundColor: '#F5ECD7', minHeight: '100vh', overflowY: 'auto' }}>
        <div style={{ maxWidth: 680, margin: '0 auto', padding: '20px 20px 100px' }}>
          ...
          <h1 style={{ margin: '0 0 4px', color: '#2C1F1A', fontSize: 28, fontWeight: 800 }}>Privacy Policy</h1>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#F5ECD7' }}>
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <Text style={{ color: '#2C1F1A', fontSize: 28, fontWeight: '800', marginBottom: 4 }}>Privacy Policy</Text>
