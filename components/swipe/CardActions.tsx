    ...
    return (
      <div
        ...
        style={{
          ...
          height: 44,
          borderRadius: 22,
          backgroundColor: isSaved ? 'rgba(255,107,53,0.18)' : 'rgba(0,0,0,0.25)',
          ...
          border: `1px solid ${isSaved ? 'rgba(255,107,53,0.35)' : 'rgba(255,255,255,0.08)'}`,
        }}
      >
  ...
  return (
    <Pressable
      ...
      style={{
        ...
        justifyContent: 'center',
        borderWidth: 1,
        borderColor: isSaved ? 'rgba(255,107,53,0.35)' : 'rgba(255,255,255,0.08)',
        transform: [{ scale }],
      }}
      hitSlop={12}
    >
