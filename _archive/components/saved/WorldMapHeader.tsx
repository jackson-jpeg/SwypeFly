...
export function WorldMapHeader({ destinations }: WorldMapHeaderProps) {
  ...
  return (
    <div style={{
      ...
      borderRadius: 20,
      margin: '0 auto 16px',
      background: 'linear-gradient(135deg, #2C1F1A 0%, #3D2E24 100%)',
    }}>
      <svg
        viewBox="0 0 900 340"
      ...
      >
        ...
        <path d="M150,80 Q180,70 220,85 Q260,75 280,90 Q300,80 320,95 L310,130 Q290,150 260,160 Q240,170 220,165 Q200,175 180,160 Q160,150 150,130 Z" fill="#A8C4B8" opacity="0.4" />
        <path d="M230,165 Q240,175 250,200 Q260,220 270,240 Q265,260 255,275 Q245,285 240,270 Q235,255 230,240 Q225,220 228,200 Z" fill="#A8C4B8" opacity="0.4" />
        <path d="M200,155 Q210,165 215,175 Q212,185 205,180 Q200,170 200,155 Z" fill="#A8C4B8" opacity="0.3" />
        <path d="M430,80 Q460,70 500,75 Q530,70 550,90 Q540,100 520,110 Q510,120 490,130 Q470,140 450,145 Q440,140 435,130 Q430,120 435,110 Q430,100 430,80 Z" fill="#A8C4B8" opacity="0.4" />
        <path d="M510,150 Q530,140 545,150 Q550,160 545,170 Q535,175 525,175 Q518,170 510,165 Z" fill="#A8C4B8" opacity="0.3" />
        <path d="M440,150 Q460,145 480,150 Q500,155 510,165 Q520,175 515,185 Q505,195 490,200 Q475,195 460,185 Q450,175 445,165 Q440,160 440,150 Z" fill="#A8C4B8" opacity="0.3" />
        <path d="M540,130 Q560,120 590,130 Q620,140 640,155 Q660,170 665,185 Q660,200 645,205 Q630,200 620,190 Q610,175 595,165 Q575,155 555,150 Q540,145 540,130 Z" fill="#A8C4B8" opacity="0.4" />
        <path d="M670,120 Q690,110 720,120 Q740,130 735,150 Q725,160 710,165 Q700,160 695,150 Q685,140 675,135 Q670,130 670,120 Z" fill="#A8C4B8" opacity="0.4" />
        <path d="M700,170 Q720,175 730,190 Q725,200 715,195 Q705,185 700,170 Z" fill="#A8C4B8" opacity="0.3" />
        <path d="M710,230 Q740,225 770,240 Q780,255 770,270 Q755,280 740,275 Q725,265 715,250 Q710,240 710,230 Z" fill="#A8C4B8" opacity="0.4" />
        <path d="M780,240 Q790,235 800,240 Q795,250 785,250 Z" fill="#A8C4B8" opacity="0.3" />
        <path d="M440,175 Q470,170 500,180 Q520,190 530,210 Q535,230 525,250 Q510,265 490,270 Q475,265 465,250 Q455,230 450,210 Q445,195 440,175 Z" fill="#A8C4B8" opacity="0.35" />
      </svg>
      {/* Animated pins */}
